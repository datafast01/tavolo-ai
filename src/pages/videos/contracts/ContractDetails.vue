            ...
            <div class="float-right">
              ...
              <v-btn elevation="24" size="large">
                ...
                <VMenu activator="parent">
                  <VList>
                    <VListItem @click="changeStatus('cancel')">

                      <VListItemTitle class="text-uppercase">Cancel</VListItemTitle>
                    </VListItem>
        ...
        <v-container class="contact">
          <v-row class="pa-5">
            ...
            <v-col cols="6">
              <v-card class="">
                <v-card-item>
                  <v-card-subtitle> Influencer Name </v-card-subtitle>
                  <v-card-title> {{ details?.influencerDetails?.name }} </v-card-title>
                </v-card-item>
              </v-card>
            </v-col>
...
export default {
  components: { ContactItem, ReviewDialog },
