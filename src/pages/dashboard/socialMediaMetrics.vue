...
<template>
    <VCard>
        ...
        <VCardText>
            <VueApexCharts type="bar" :options="options" :series="series" :height="203" />
        </VCardText>

        <!-- <VCardText class="d-flex justify-space-around">
            <div v-for="data in weeklySalesData" :key="data.title" class="d-flex align-center me-3">
                <div>
                    <VAvatar rounded :color="data.avatar.color" variant="tonal" class="me-4">
