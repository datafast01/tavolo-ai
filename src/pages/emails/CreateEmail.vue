    ...
    <VCard class="pa-0 pa-sm-0">
                ...
                <VRow>
                    <VCol cols="12" class="text-center ">
                            ...
                            <div class="py-3" style="border: 1px dashed; border-radius: 6px">
                                <div class="me-3 py-1 flex-column d-flex align-center justify-space-between">
                                    ...
                                    <div class="pt-3 pb-1">
                                        ...
                                        <input ref="refInputEl" type="file" name="file" accept="image/*"
                        ...
                        <div class="d-flex align-center justify-center my-8">
                            <div class="d-flex align-center justify-center sequence-btn mr-4"
                                style="border: 1px solid; border-radius: 5px" v-for="button in buttons" :key="button">
        ...
        <v-dialog max-width="800" v-model="addAButtonDialog">
            <v-card>
                ...
                <v-card-subtitle>
                    <div>
                        Choose the type of the button below.
                    </div>
                </v-card-subtitle>
                <v-card-text>
                    ...
                    <v-select label="Platform" :items="platforms" item-value="value" item-title="title"
